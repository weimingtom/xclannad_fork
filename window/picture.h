...
class PicContainer : public PicBase {
	...
	void BlitBack(iterator z, Rect rpos); 
	void BlitFront(iterator z, Rect rpos); 
...
public:
	...
	Surface* NewSurfaceFromRGBAData(int w, int h, char* data, MaskType with_mask) const; 
