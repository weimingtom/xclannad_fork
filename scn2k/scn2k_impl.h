...
class Scn2k : Event::Time {
	...
	int scn_number;
	int scn_point;
	enum {SCN_INFO=999999, SCN_INFO_MENU=10000001, SCN_INFO_LOCALS = 10000100, SCN_INFO_LOCALSTR = 10000200, SCN_INFO_RETSTR = 10000300};
	...
	void LoadSys(void);
public:
	Scn2k(Event::Container& _event, PicContainer& _parent, struct MuSys& mu, AyuSysConfig& config);
	~Scn2k();
