...
int WAVFILE_Converter::Read(char* buf, int blksize, int blklen) {
	...
	if (cvt->len < blksize*blklen) {
		...
		do {
			...
			if (freq < original->wavinfo.SamplingRate) { 
